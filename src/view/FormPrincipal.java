...
public class FormPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Pesquisar Música"));
    ...
    public void listarMusicas(String busca) throws SQLException {
        ResultSet rs = null;
        
        try {
            rs = this.musica.selectAll(busca);
        } catch (SQLException ex) {
            Logger.getLogger(FormPrincipal.class.getName()).log(Level.SEVERE, null, ex);
        }
